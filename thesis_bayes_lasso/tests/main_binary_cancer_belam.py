...
save_xtra = os.path.join("SIMULATION","BINARY","CANCER","BELAM")
...
for la in range(len(lamvals)):
    ...
    for be in range(len(betavals)):
        ...
        print(subdir)
        save_sub = os.path.join("SIMULATION","BINARY","CANCER","BELAM",subdir)
...
for i in range(n_methods): 
    ...
    ax.set_yscale('log')  # Log scale for Lambda
    ax.set_title('Heatmap: Accuracy (Color) + Entropy (Contours)')
...
for i in range(n_methods): 
    ...
    #ax.set_xscale('log')  # Log scale for Beta
    ax.set_yscale('log')  # Log scale for Lambda
    ax.set_title('Heatmap: Accuracy (Color) + ROC-AUC (Contours)')
